...
const contracts: Record<string, GrantContract> = {
  ...Object.fromEntries(['entitlement', 'pool', 'pool_key', 'pool_source_binding', 'data_source', 'introspection_run', 'catalog_object', 'catalog_element', 'element_stats', 'filing_party', 'filing_party_rule'].map((table) => [table, {
