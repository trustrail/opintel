...
import type { Cedant, CedantFileRule } from '../domain/identify.js';
...
export interface FileExtractor {
  inspect(path: string, sha256: string, cedant: Cedant, rule: CedantFileRule): Promise<Result<ExtractionSummary>>;
}
