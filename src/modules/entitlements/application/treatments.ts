...
export type TreatmentStrategy =
 ...
 | { kind: 'clear'; outputType: ExposedType; apply(value: unknown): Promise<Result<unknown>> }
 ...
 | { kind: 'aggregate_only'; outputType: ExposedType; constraint: { kind: 'aggregate_only'; elementId: ElementId } };
...
export class TreatmentStrategies {
 ...
 resolve(element: { id: ElementId; type: ExposedType | null }, decision: Entitlement | null): Result<TreatmentStrategy> {
