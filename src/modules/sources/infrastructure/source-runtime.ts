import { KeyCustodyService,PostgresCustodyRepository,SidecarCustodyClient } from '../../entitlements/index.js';
...
export function createSourceRuntime(options:SidecarOptions, events?:ProjectEvents){
 const custody=new KeyCustodyService(new PostgresCustodyRepository(),new SidecarCustodyClient(options),{checkMany:async()=>[]} as Pick<import('../../authz/index.js').AuthorizationPort,'checkMany'>);
