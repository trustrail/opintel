import type { ProjectId, UserId, SourceId, RunId, Result, Timestamp } from '../../../shared/kernel/index.js';
...
export type IntrospectionSource = { id: SourceId; projectId: ProjectId; kind: SourceKind; credentialRef: VaultRef | null; status: SourceStatus };
...
export interface IntrospectionStore {
  ...
  fail(ctx: IntrospectionContext, id: RunId, reason: string, unreachable: boolean): Promise<Result<IntrospectionRun>>;
