...
export const IntrospectionRunView = z.object({
 ...
 diff:z.array(z.object({change:z.enum(['added','removed','renamed','type_changed','collision']),elementId:z.uuid().nullable(),exposedName:z.string().nullable(),before:z.string().nullable(),after:z.string().nullable(),breaking:z.boolean()})).nullable(),
});
