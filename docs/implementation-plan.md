...
| 3.15 | Introspection run and diff screen, five-second polling until SSE in 3.16 | 3.6 (3.16 upgrades progress transport) | screen | G-003 to G-009 |
...
| 4.4 | **View compiler**, undecided and withheld distinguished in metadata. **Hand-written** | 4.1, 3.2 | `entitlements/compile.ts` | VC-01 to VC-28 |
...
| 4.7 | Bulk set with justification on clear | 4.1 | endpoint | H-010 to H-012 |
